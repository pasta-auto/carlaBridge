...
inline static autoware_auto_vehicle_msgs::msg::GearCommand::_command_type tier4_external_api_2_autoware_gears(tier4_external_api_msgs::msg::GearShift::_data_type newGear)
{
    autoware_auto_vehicle_msgs::msg::GearCommand::_command_type gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::NONE;

    switch(newGear)
    {
        case tier4_external_api_msgs::msg::GearShift::PARKING:
            gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::PARK;
            break;
        case tier4_external_api_msgs::msg::GearShift::REVERSE:
            gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::REVERSE;
            break;
        case tier4_external_api_msgs::msg::GearShift::NEUTRAL:
            gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::NEUTRAL;
            break;
        case tier4_external_api_msgs::msg::GearShift::DRIVE:
            gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::DRIVE;
            break;
        case  tier4_external_api_msgs::msg::GearShift::LOW:
            gearRet = autoware_auto_vehicle_msgs::msg::GearCommand::LOW;
            break;
        default:
            break;
    }
